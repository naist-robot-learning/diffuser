...
def visualize_trajectories(directory):
    ...
    for npz_file in npz_files:
        ...
        q = npz_data["joint_position"][3]  # Trials x horizon x transition 100 x 48 x 6
        ...
        ax.text(x[0] + 0.01, y[0] - 0.07, z[0] + 0.07, "Start", fontsize=16, ha="left")
        ax.scatter(x[-1], y[-1], z[-1], marker="o", s=100, color="g")
        ax.text(x[-1] + 0.01, y[-1] - 0.07, z[-1] - 0.10, "Goal", fontsize=16, ha="left")
        ...
        ax.set_ylabel(r"Y (m)", fontsize="16", labelpad=15)
        ax.set_zlabel(r"Z (m)", fontsize="16", labelpad=15)
...
exp_name = "RealRobotTomm/plannedTraj"
